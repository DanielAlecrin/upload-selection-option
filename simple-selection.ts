...
fetch('https://supply.logistica.staging.totvs.app/checklist/core/api/v1/scripts/bce55718-0f5b-4823-bc2a-9510ab4ae2a5/categories/stepByStep', {
    method: 'POST',
...
interface Item {
    ...
    rule: Rule;
    statement: string;
    totalPontuation?: number | null;
    options: Option[];
}

interface Rule {
    allowPontuation: boolean;
    required: boolean;
    withoutObservation: boolean;
    localizationRestriction: LocalizationType;
    media: Media;
    selection: Media;
}
